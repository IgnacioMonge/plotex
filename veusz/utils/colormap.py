...
_defaultmaps = {
    ...
    # Perceptually uniform (matplotlib/BIDS) - (B, G, R, A)
    ...
    # ── ColorBrewer qualitative palettes (step mode) ─────────
    # (B, G, R, A) format. (-1,0,0,0) enables step mode.

    # Set1 - Bold primary colors, high contrast
    'cb-set1': (
        (-1, 0, 0, 0),
        ( 44,  62, 228, 255),  # red
        ( 193, 134,  55, 255),  # blue
        ( 61, 174,  77, 255),  # green
        ( 210,  78, 152, 255),  # purple
        ( 22, 163, 255, 255),  # orange
        ( 64, 255, 255, 255),  # yellow
        ( 182,  97, 166, 255),  # brown
        ( 193, 128, 247, 255),  # pink
        ( 153, 153, 153, 255),  # grey
    ),
    # Set2 - Pastel, colorblind-friendlier
    'cb-set2': (
        (-1, 0, 0, 0),
        ( 133, 179, 102, 255),  # teal
        ( 106, 141, 252, 255),  # salmon
        ( 197, 180, 141, 255),  # lavender
        ( 150, 115, 228, 255),  # pink
        ( 128, 205, 164, 255),  # lime
        ( 102, 225, 255, 255),  # peach
        ( 193, 212, 229, 255),  # tan
        ( 186, 186, 179, 255),  # grey
    ),
    # Paired - 12 colors in light/dark pairs
    'cb-paired': (
        (-1, 0, 0, 0),
        ( 201, 178, 166, 255),  # light blue
        ( 180,  89,  31, 255),  # dark blue
        ( 144, 219, 178, 255),  # light green
        ( 57, 110,  51, 255),   # dark green
        ( 154, 153, 251, 255),  # light red
        ( 47,  39, 227, 255),   # dark red
        ( 185, 202, 253, 255),  # light orange
        ( 22, 127, 255, 255),   # dark orange
        ( 255, 191, 202, 255),  # light purple
        ( 152,  51, 106, 255),  # dark purple
        ( 153, 255, 255, 255),  # light yellow
        ( 43, 100, 177, 255),   # brown
    ),
    # Dark2 - Muted dark, good for lines
    'cb-dark2': (
        (-1, 0, 0, 0),
        ( 135, 142,  27, 255),  # teal
        ( 53,  86, 217, 255),   # orange
        ( 173,  98, 116, 255),  # purple
        ( 73, 149, 231, 255),   # pink
        ( 47, 160, 102, 255),   # green
        ( 68, 170, 230, 255),   # yellow-brown
        ( 108, 108, 166, 255),  # brown
    ...
    # YlOrRd - Yellow-Orange-Red (common for heatmaps)
    'cb-ylorrd': (
        (204, 255, 255, 255),
        (155, 237, 254, 255),
        (109, 211, 254, 255),
    ...
    # ── Journal palettes (ggsci-inspired, step mode) ─────────

    # Nature Publishing Group
    'npg': (
        (-1, 0, 0, 0),
        ( 53,  75, 230, 255),  # E64B35
        (213, 189,  77, 255),  # 4DBBD5
        (135, 160,   0, 255),  # 00A087
        (136,  84,  60, 255),  # 3C5488
        (127, 155, 243, 255),  # F39B7F
        (180, 145, 132, 255),  # 8491B4
        (194, 209, 145, 255),  # 91D1C2
        (  0,   0, 220, 255),  # DC0000
        ( 72,  97, 126, 255),  # 7E6148
    ),
    # NEJM
    'nejm': (
        (-1, 0, 0, 0),
        ( 41,  60, 188, 255),  # BC3C29
        (181, 114,   0, 255),  # 0072B5
        ( 39, 135, 225, 255),  # E18727
        ( 78, 133,  32, 255),  # 20854E
        (177, 118, 120, 255),  # 7876B1
        (173, 153, 111, 255),  # 6F99AD
        (145, 220, 255, 255),  # FFDC91
        (151,  76, 238, 255),  # EE4C97
    ),
    # Lancet
    'lancet': (
        (-1, 0, 0, 0),
        (139,  70,   0, 255),  # 00468B
        (  0,   0, 237, 255),  # ED0000
        ( 64, 181,  66, 255),  # 42B540
        (180, 153,   0, 255),  # 0099B4
        (159,  94, 146, 255),  # 925E9F
        (145, 175, 253, 255),  # FDAF91
        ( 42,   0, 173, 255),  # AD002A
        (182, 182, 173, 255),  # ADB6B6
    ),
    # JAMA
    'jama': (
        (-1, 0, 0, 0),
        ( 85,  78,  55, 255),  # 374E55
        ( 68, 143, 223, 255),  # DF8F44
        (213, 161,   0, 255),  # 00A1D5
        ( 69,  71, 178, 255),  # B24745
        (151, 175, 121, 255),  # 79AF97
        (153,  85, 106, 255),  # 6A6599
        (107, 121, 128, 255),  # 80796B
    ),
    # Science (AAAS)
    'aaas': (
        (-1, 0, 0, 0),
        (146,  73,  59, 255),  # 3B4992
        (  0,   0, 238, 255),  # EE0000
        ( 69, 139,   0, 255),  # 008B45
        (121,  24,  99, 255),  # 631879
        (128, 130,   0, 255),  # 008280
        ( 33,   0, 187, 255),  # BB0021
        (155,  85,  95, 255),  # 5F559B
        ( 86,   0, 162, 255),  # A20056
    ),
    # Okabe-Ito (colorblind-safe universal)
    'okabe-ito': (
        (-1, 0, 0, 0),
        (  0, 159, 230, 255),  # orange
        (233, 180,  86, 255),  # sky blue
        (115, 158,   0, 255),  # bluish green
        ( 66, 228, 240, 255),  # yellow
        (178, 114,   0, 255),  # blue
        (  0,  94, 213, 255),  # vermillion
        (167, 121, 204, 255),  # reddish purple
    ),
}
...
def stepCMap(cmap, n):
    ...
    cmap = N.asarray(cmap, dtype=N.float64)
    x = N.linspace(0, 1, n)
    xp = N.linspace(0, 1, len(cmap))

    # interpolate all 4 channels in one pass
    stepped = N.column_stack([N.interp(x, xp, cmap[:,i]) for i in range(4)])

    return N.vstack( ([-1,0,0,0], stepped) ).astype(N.intc)
...
class ColorMaps:
    ...
    _re_step = re.compile(r'^(.+)-step([0-9]*)$')
...
def importColormapFromFile(filename):
    """Import a colormap from a file (.txt/.csv, .gpl, .cpt).

    Returns (name, cmap_tuple) where cmap_tuple is a Veusz colormap
    (tuple of BGRA int tuples).
    """
    import os
    ...
    if ext in ('.txt', '.csv'):
        return name, _import_rgb_txt(filename)
    elif ext == '.gpl':
        return name, _import_gpl(filename)
    elif ext == '.cpt':
        return name, _import_cpt(filename)
    else:
        raise ValueError('Unsupported colormap format: %s' % ext)


def _import_rgb_txt(filename):
    """Import CSV/TXT with R,G,B values (0-1 float or 0-255 int)."""
    lines = []
...
def _import_gpl(filename):
    """Import GIMP Palette (.gpl) — discrete palette."""
    colors = []
    header_done = False
    with open(filename, 'r') as f:
        for line in f:
            line = line.strip()
            if not header_done:
                if line == '#' or (header_done is False and
                        not line.startswith('GIMP') and
                        not line.startswith('Name:') and
                        not line.startswith('Columns:')):
                    header_done = True
                    if line == '#':
                        continue
                else:
            ...
            try:
                ...
                continue
            colors.append((b, g, r, 255))  # BGRA

    if not colors:
        raise ValueError('No valid colors in GPL file')
    # discrete: add step flag
    return tuple([(-1, 0, 0, 0)] + colors)


def _import_cpt(filename):
    """Import GMT Color Palette Table (.cpt) — continuous gradient."""
    stops = []
    with open(filename, 'r') as f:
        for line in f:
            line = line.strip()
            ...
            if len(parts) < 8:
                continue
            try:
                r0, g0, b0 = int(parts[1]), int(parts[2]), int(parts[3])
                r1, g1, b1 = int(parts[5]), int(parts[6]), int(parts[7])
            except (ValueError, IndexError):
                continue
            if not stops:
                stops.append((b0, g0, r0, 255))
            stops.append((b1, g1, r1, 255))

    if not stops:
        raise ValueError('No valid color data in CPT file')
    return tuple(stops)
