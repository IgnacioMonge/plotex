# A module for embedding Plotex within another python program
#
...
"""This module allows Plotex to be embedded within other Python programs.
For example:
...
class Embedded:
    ...
    This embedded instance supports all the normal Plotex functions
    """
