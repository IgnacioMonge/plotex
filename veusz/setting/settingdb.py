...
defaultValues = {
    ...
    # copy-as-image options
    'copyimage_format': 'png',  # png, svg, bmp, jpg, emf
    'copyimage_dpi': 150,
    'copyimage_quality': 90,
    ...
    # canvas helpers
    'guides_snap_enabled': True,
    'guides_snap_threshold': 8,
    'rulers_default': False,
    'rulers_unit': 'cm',
}
...
class _SettingDB:
    ...
    def readSettings(self):
        ...
        for key in s.childKeys():
            ...
            try:
                self.database[realkey] = ast.literal_eval(val)
