...
Please report bugs at https://github.com/IgnacioMonge/plotex/issues
(Plotex fork; upstream Veusz issues at https://github.com/veusz/veusz/issues).

=head1 AUTHORS

B<Plotex> is a fork of B<Veusz> by M. Ignacio Monge GarcE<iacute>a.
